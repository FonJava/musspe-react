    ...
    <>
      ...
      <section className="relative bg-[#FFDCD2] h-[200px] sm:h-[300px]">
        <img
          ...
          draggable="false"
        />
        <div className="display flex w-full sm:w-[750px] lg:w-[1000px] mx-auto relative">
          <img
            src={detalhevazio}
            className="w-[152px] sm:w-[425px] lg:w-[455px] absolute top-[182px] sm:top-[250px] lg:bottom-[-56px] right-[5%]"
            draggable="false"
          />
          <img
            src={detalhe}
            className="w-[152px] sm:w-[425px] lg:w-[455px] absolute top-[24px] sm:top-0 right-[5%]"
            draggable="false"
          />
          <img
            src={notidialogo}
            className="w-[240px] sm:w-[420px] lg:w-[455px] relative left-0 sm:left-[7%] top-[71px] sm:top-[75px] lg:top-[56px]"
            draggable="false"
          />
          <div
            className="relative top-[135px] sm:top-[184px] lg:top-[172px] left-[-140px] sm:left-[-230px] lg:left-[-250px] w-[210px] sm:w-[270px] lg:w-[300px] text-brand-laranja font-barlow-medium text-[12px] sm:text-[21px] text-center"
          ...
          <div className="absolute right-[5%] border-[0.5px] sm:border-2 border-brand-roxo rounded-lg text-center w-[83px] sm:w-[230px] lg:w-[247px] top-[56px] sm:top-[85px] lg:top-[80px] p-[-10px] sm:p-0">
